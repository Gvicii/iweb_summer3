...
public class OrderDAO {
	...
	public static final String waitConfirm = "waitConfirm";//等待确认收货
	public static final String waitReview = "waitReview";//等待评价
	public static final String finish = "finish";//定单结束
	public static final String delete = "delete";//订单处于被删除状态
    //给订单一个已标记
